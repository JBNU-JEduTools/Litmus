...
ALLOWED_HOSTS = ['jota.jbnu.ac.kr']
#ALLOWED_HOSTS = ['203.254.143.230']
...
ADMINS = (
    ('Hyunchan Park', 'hcpark.class@gmail.com'),
)

# The sender for the aforementioned emails.
SERVER_EMAIL = 'DMOJ: Modern Online Judge <hcpark.class@gmailcom>'
...
SITE_NAME = 'JOTA'
SITE_LONG_NAME = 'JOTA: JBNU Online Teaching Assistant'
SITE_ADMIN_EMAIL = 'hyunchan.park@jbnu.ac.kr'
...
EVENT_DAEMON_GET = 'ws://203.254.143.230:18104/event/'
...
LOGGING = {
    ...
    'handlers': {
        ...
        'bridge': {
            ...
            'filename': '/var/log/dmoj/bridge.log',
